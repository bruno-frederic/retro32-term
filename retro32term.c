 ...
 *
 * DCTelnet must also include the standard NDK headers before using this
 * module.
 *
 * Outgoing data is transmitted through DCTelnet?s TCPSend(), which replaces
 * ser_write() as the data output function.
 */
#define ser_write(data, len) TCPSend((data), (len))
